...
<%!
	public static final String EMP_EDIT_URL = "pages/back/admin/EmpAction!edit.action" ;
%>
					...
					<form class="form-horizontal" action="<%=EMP_EDIT_URL%>" id="myform" method="post" enctype="multipart/form-data">
						<fieldset>
								...
								<div class="col-md-5">
									<select id="lid" name="lid" class="form-control">
										...
										<c:forEach items="${levels}" var="level">
											<option value="${level.lid}" hisal="${level.hisal}" losal="${level.losal}" ${level.lid==emp.lid ?'selected':''}>${level.title}</option>
										</c:forEach>
									</select>
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="salaryDiv">
								...
								<!-- 定义表单错误提示显示元素 -->
								<div class="col-md-4" ><span id="salaryMsg"></span></div>
							</div>
							...
							<div class="form-group">
								<div class="col-md-5 col-md-offset-3">
									<input type="hidden" id="oldphoto" name="oldphoto" value="${emp.photo}">

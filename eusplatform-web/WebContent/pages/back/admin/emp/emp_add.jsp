...
<%!
	public static final String EMP_ADD_URL = "pages/back/admin/EmpAction!add.action" ;
%>
								...
								<div class="col-md-5">
									<select id="lid" name="lid" class="form-control">
										...
										<c:forEach items="${levels}" var="level">
											<option value="${level.lid}" hisal="${level.hisal}" losal="${level.losal}">${level.title}</option>
										</c:forEach>
									</select>
								</div>
								<!-- 定义表单错误提示显示元素 -->

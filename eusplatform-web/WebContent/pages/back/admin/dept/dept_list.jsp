					...
					<tbody>
					 <c:forEach items="${allDept}" var="dept">
						<tr>
							...
							<td class="text-center"><span id="eid-${dept.eid}" style="cursor:pointer;">${empName[dept.did].ename}</span></td> 
							...
							<td class="text-center">
								<button id="edit-${dept.did}" class="btn btn-warning">
										<span id="edit-1 class="glyphicon glyphicon-edit"></span>&nbsp;编辑</button>
							</td>
						</tr> 
						</c:forEach>
					</tbody>

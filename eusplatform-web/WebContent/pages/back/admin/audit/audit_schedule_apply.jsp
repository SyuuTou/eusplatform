...
<%!
	public static final String SCHEDULE_AUDIT_URL = "pages/back/admin/schedule/ScheduleAction!processApply.action?sid=" ;
%>
					...
					<div>
						<table class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td>${schedule.scheduleState}</td>
							</tr>
						</table>
					</div>
					<div>
						<form class="form-horizontal" action="<%=SCHEDULE_AUDIT_URL%>${schedule.sid}" id="myform" method="post">
							<fieldset>
								<div class="form-group" id="auditDiv">
									...
									<div class="col-md-5">
										<div class="radio-inline">
											<label><input type="radio" name ="audit" id="audit" verify="audit-2" value="2" checked>
												&nbsp;<span class="text-danger">拒绝</span></label>
										</div> 
										<div class="radio-inline">
											<label><input type="radio" id="audit" name ="audit" verify="audit-1"value="1">
								...
								<input  type="hidden" id="seid" name ="seid" value="${schedule.seid}" >
							...
							<div class="panel-heading">
								<h4 class="panel-title"> 
									<a data-toggle="collapse" data-parent="news" href="#contentOne">
										<strong><span class="glyphicon glyphicon-user"></span>&nbsp;出差人员安排（总人数：${empCount}人）</strong>
									</a>
								</h4>
							</div>
									...
									<table class="table table-condensed">
										...
										<tbody>
											<c:forEach items="${emps}"  var="emp">
												...
												<td class="text-center">${levels[emp.lid]}</td>
												<td class="text-center">${emp.hiredate}</td>
												<td class="text-center" id="dname">${dnames[emp.did]}</td>
											</tr> 
											</c:forEach>
										</tbody>
									</table>
